...
<link rel="stylesheet" type="text/css" href="css/font-awesome.min.css">
 <link href="css/style.css" rel="stylesheet" type="text/css" />
    <link href="css/feathericon.css" rel="stylesheet" type="text/css" />
<!-- END VENDOR CSS-->
<!-- BEGIN STACK CSS-->
...
<h3 class="content-header-title mb-0">Pending Bounce Cheques</h3>
<div class="row breadcrumbs-top">
<div class="breadcrumb-wrapper col-xs-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.htm">Home</a></li>
<li class="breadcrumb-item"><a href="#">Cheque Detail</a></li>
<li class="breadcrumb-item active"><a href="#">Pending Bounce Cheques</a></li>
</ol>
</div>
</div>
</div>
...
<h4 class="card-title" id="basic-layout-form">Pending Bounce Cheques</h4>
...
<th>Date</th>
<th>Retailer Name</th>
<th class="text-xs-right">Chq No.</th>
<th class="text-xs-right">Chq Date</th>
<th class="text-xs-right">Chq Amount</th>
<th>Bank Name</th>
<th>Bill No.</th>
<th>Bounce Date</th>
<th>Reason</th>
<th>Penalty</th>
<th>Entry in Accounts</th>
<th>Pricipal Received</th>
<th>Penalty Received</th>
<th class="text-xs-right">Chq No.</th>
<th class="text-xs-right">Chq Date</th>
<th class="text-xs-right">Chq Amount</th>
<th>Bank Name</th>
<th>Clearing in Accounts</th>
</tr>
</thead>
<tbody>
<tr>
...
<td><a href="#" class="btn btn-primary btn-sm">Done</a></td>
<td class="text-xs-right">20,000</td>
<td class="text-xs-right">200</td>
<td></td>
<td></td>
<td></td>
<td class="text-xs-right">9,000</td>
<td><a href="#" class="btn btn-primary btn-sm">Done</a></td>
</tr>
...
<td>
<input id="Text2" type="text" value="120" style="width:60px">
</td>
<td><a href="#" class="btn btn-primary btn-sm">Done</a></td>
<td class="text-xs-right">20,000</td>
<td class="text-xs-right">200</td>
...
<td>
<input id="Text3" type="text" value="120" style="width:60px">
</td>
<td><a href="#" class="btn btn-primary btn-sm">Done</a></td>
<td class="text-xs-right">20,000</td>
<td class="text-xs-right">200</td>
...
<td>
<input id="Text4" type="text" value="120" style="width:60px">
</td>
<td><a href="#" class="btn btn-primary btn-sm">Done</a></td>
<td class="text-xs-right">20,000</td>
<td class="text-xs-right">200</td>
...
<!-- END STACK JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script type="text/javascript" src="js/breadcrumbs-with-stats.min.js"></script>
<!-- END PAGE LEVEL JS-->
</body>
</html>