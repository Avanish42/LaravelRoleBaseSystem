...
<h4 class="card-title" id="basic-layout-form">Cheque Register</h4>
</div>
...
<label class="checkbox-inline">
  <input type="checkbox" id="Checkbox1" value="option1"> Club
</label>
</td>
<td></td>
</tr>
...
<td><label class="checkbox-inline">
  <input type="checkbox" id="Checkbox2" value="option1"> Club
</label></td>
<td></td>
</tr>
<tr>
